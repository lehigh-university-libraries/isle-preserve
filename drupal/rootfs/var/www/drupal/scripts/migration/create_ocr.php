...
$ocr_action  = $entity_type_manager->getStorage('action')
  ->load('get_ocr_from_image');
...
while (1) {
  $nids = \Drupal::database()->query("SELECT mo.field_media_of_target_id
    ...
    WHERE mu.field_media_use_target_id = :original_tid
      ...
      AND mt.field_mime_type_value = 'application/pdf'
