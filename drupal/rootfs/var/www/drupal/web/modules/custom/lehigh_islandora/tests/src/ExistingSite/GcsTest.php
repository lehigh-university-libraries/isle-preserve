...
/**
 * Test to ensure uploads to Google Cloud Storage work.
 */
class GcsTest extends ExistingSiteBase {
  ...
  /**
   * Create and delete a file in Google Cloud Storage.
   */
  public function testGcsUploadAndDelete() {
    ...
    $file = $file_storage->create([
      'uri' => "gs-production://test.html",
      'filename' => "test.html",
      'filemime' => 'text/plain',
      'uid' => 1,
      'status' => 1,
    ]);
    $file_system->copy($path, 'gs-production://test.html', FileSystemInterface::EXISTS_REPLACE);
