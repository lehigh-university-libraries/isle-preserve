  ...
  var extensionMethods = {
    ...
    pips: function (settings) {
        ...
        single: function (value) {
          ...
          if (slider.options.range) {
            $pips.each(function (k, v) {
              ...
              if (
                (slider.options.range === "min" && pipVal < value) ||
      ...
      function createPip(which) {
        ...
        if (values && values.length) {
          ...
          if (slider.options.range) {
            if (
              (slider.options.range === "min" && labelValue < value) ||
        ...
        css =
          slider.options.orientation === "horizontal"
            ? "left: " + percent
            : "bottom: " + percent;
      ...
      if (
        $._data(slider.element.get(0), "events").mousedown &&
      ...
      slider.element.on(
        "slide.selectPip slidechange.selectPip",
        function (e, ui) {
          var $slider = $(this),
    ...
    float: function (settings) {
      ...
      if (options.handle) {
        ...
        tipValues =
          slider.values() && slider.values().length
            ? getPipLabels(values)
            : getPipLabels([value]);
